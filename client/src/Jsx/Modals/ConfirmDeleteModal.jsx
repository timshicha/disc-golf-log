...
const ConfirmDeleteModal = (props) => {
    ...
    return (
        <MenuModal replaceImg={props.replaceImg} onClose={props.onClose}>
            <ModalTitle>{props.modalTitle || "Confirm Delete?"}</ModalTitle>
            <ModalButton className="w-[45%] bg-gray-dark text-white m-[5px]" onClick={props.onClose}>Cancel</ModalButton>
